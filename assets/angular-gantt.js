...
angular.module('ganttTemplates', []).run(['$templateCache', function($templateCache) {
    $templateCache.put('template/default.gantt.tmpl.html',
        ...
        '                         ng-class="timeFrame.timeFrame.working && \'gantt-timeframe-working\' || \'gantt-timeframe-non-working\'"\n' +
        '                         ng-style="{\'left\': timeFrame.left + \'px\', \'width\': timeFrame.width + \'px\'}"\n' +
        '                         ng-repeat="timeFrame in column.timeFrames | filter:{hidden:false}"></div>\n' +
        '                </gantt-column>\n' +
        '            </gantt-body-columns>\n' +
        '            <gantt-body-rows>\n' +
